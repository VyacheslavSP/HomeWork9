...
/* видимо цель всей домашней работы познакомит нас с ошибкой переполнения стека, особенно это задание)
Насколько я понял с просторов интернета, в современной .Net данная ошибка ловится автоматически и принудительно убивает
